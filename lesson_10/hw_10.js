...
//     let objectForm1  =document.createElement('div');
//     document.body.appendChild(objectForm1);
//     let fullname = document.createElement('h1');
//     fullname.innerText = `${this.name.value} ${this.surname.value}`;
//     let age = document.createElement('h2');
//     age.innerText = `${this.age.value}`;
//     objectForm1.append(fullname,age);
// }
// ==========================
...
let currentPage = 1;
let num = 10;
let listVis = pagesDiller(locations,num,[]);
pgge(listVis,7,num);

let prew = document.getElementById(Prew);
let next = document.getElementById(Next);

function pagesDiller(array,num, listAra) {
    let list = [];
    let pages = array.length/num;
    for (i=0;i<pages; i++) {
...
function pgge(list,numPage,num) {
    let div = document.getElementById('list');
    for (i=0;i<num;i++) {
        let hhhh =  document.createElement('h4');
        let pppp = document.createElement('p');
        hhhh.innerText = `${list[numPage][i].title}`;
        pppp.innerText = `${list[numPage][i].type}`;
        div.append(hhhh,pppp);
    }
}
